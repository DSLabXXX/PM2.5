...
if is_training:
    ...
    for i in [3, 6, 9, 12, 24]:
        first_layer_time = Conv2D(128, kernel_size=(i, input_size), activation='relu')(model_input_time)
        second_layer_time = Conv2D(64, kernel_size=(i, 1), activation='relu')(first_layer_time)
    ...
    cnn_model_time = Dense(128, activation='relu')(cnn_model_time)
    ...
    first_layer_freq = Conv2D(128, kernel_size=(i, freq_input_size), activation='relu')(model_input_freq)
    ...
    cnn_model_freq = Dense(128, activation='relu')(cnn_model_freq)
